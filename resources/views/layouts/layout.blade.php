...
<body>
	...
	<footer class="page-footer cyan darken-4">
		...
		<div class="footer-copyright">
			<div class="container">
				By <a class="orange-text text-lighten-3" href="https://github.com/WalexTobar">Wilber Tobar</a>(frontend) & 
			<a class="orange-text text-lighten-3" href="https://github.com/Urrutia96">Santos Urrutia</a>(backend)
			</div>
		</div>
	</footer>
	<!--Finish Footer-->
